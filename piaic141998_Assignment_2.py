...
def function4():
    ...
    return swap_cols(arr, 1, 2)  #wrtie your code here
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function9():
    ...
    a = np.arange(0, 100, 2) # write your code here
...
def function12():
    ...
    ans2=np.tile(arr,3)
    ans=np.concatenate([ans1,ans2])#write your code here 
...
def function18():
    ...
    x = np.isin(piaic,students).sum() # Write you code Here
    return x
